...
class ZipLoader(BaseLoader):
    ...
    def process_data(self, *args, **kwargs):
        ...
        return loader_class.load(force=False)
    ...
    def _load_from_file(self):
        def get_archive_prefix() -> str:
            ...
            if not self.get_file_is_url(file_url):
        ...
        with tempfile.TemporaryDirectory() as tmpdir, zipfile.ZipFile(self.file_url) as zip_ref:
            ...
            match len(can_be_loaded_filenames):
                ...
                case _:
                    ...
                    archive_filename = get_archive_prefix()
                    can_be_loaded_filenames = [
                        filename
    ...
    def _loader_class_resolver_from_url(self) -> Type | None:
        ...
        url_path_parts = set(url_path.split("/"))

        potential_extentions = url_path_parts & LOADER_CLASSES.keys()
