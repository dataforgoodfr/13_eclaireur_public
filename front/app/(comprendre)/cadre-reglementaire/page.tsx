...
import Card, { Paragraph } from '#app/components/SectionCard';
          ...
          <Paragraph>
            <ul className='list-disc space-y-1 pl-5'>
              <li>
                ...
                d’octobre 2016 établit le cadre général de l'ouverture des données publiques en
                France
              </li>
              <li>
                L'
          ...
          <Paragraph>
            <ul className='list-disc space-y-1 pl-5'>
              ...
              <li>
                ...
                : Précise que les données essentielles doivent être publiées sur le profil
                d’acheteur (plateforme électronique dédiée) et fixe leur caractère “libre, direct et
                complet”. Pour les marchés entre 25 000 € HT et 40 000 € HT, l’acheteur peut publier
          ...
          <table className=''>
            ...
            <tbody className='text-lg leading-6'>
              <tr className='border-y-2 p-2'>
                ...
                <td className=''>40 000 €HT</td>
                <td className=''>25 000 €HT</td>
              </tr>
              <tr className='border-y-2'>
                <td className=''>Obligation de publication de données en Open Data</td>
                <td className=''>
                  Marchés publics &gt; 40 000 €HT
                  <br />
                  Information sans obligation de détail pour les marchés de 25 à 40 000 € HT
                </td>
                <td className=''>Marchés publics &gt; 25 000 €HT</td>
              </tr>
              <tr className='border-y-2'>
                <td className=''>Contrats de concession</td>
                <td className=''>
                  Assimilés à des marchés publics: règles identiques (mais sans condition de seuil)
                </td>
                <td className=''>Règles spécifiques</td>
              </tr>
              <tr className='border-y-2'>
                <td className=''>Digitalisation de la commande publique</td>
                <td className=''>
                  Obligation de l'utilisation d'une plateforme numérique pour la publication des
                  appels d'offres
                </td>
                <td className=''>Néant</td>
              </tr>
              <tr className='border-y-2'>
                <td className=''>
                  Publication obligatoire des données sur la plateforme nationale
                </td>
                <td className=''>Uniquement depuis 2024: publication sur data.gouv.fr</td>
                <td className=''>Néant (aucune obligation de plateforme)</td>
              </tr>
            </tbody>
          </table>
        </Card>
      </div>
      <Link href='https://schema.data.gouv.fr/' className='underline'>
        data.gouv.fr
      </Link>{' '}
