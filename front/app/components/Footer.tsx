  ...
  return (
    <footer className='relative w-full bg-none object-cover'>
      <div className='global-margin flex h-full items-center justify-center'>
        ...
        <div className='w-full px-4 py-8 md:px-6 lg:px-8'>
          <div className='mb-8 flex flex-col gap-6 md:flex-row md:items-center md:justify-between'>
            <div className='flex flex-col items-start gap-2'>
              ...
              {/* Social media  */}
              <>
                <span className='text-tag font-semibold text-secondary-dark md:mt-2 md:block hidden'>Suivez-nous</span>
        ...
        <div>
          <h3 className='mb-4 text-lg font-semibold text-secondary'>Comprendre</h3>
          <ul className='space-y-2'>
            <li>
              <Link href='#' className='text-muted hover:text-primary hover:underline'>
                Qui sommes nous
              </Link>
            </li>
            <li>
        ...
        <div>
          <h3 className='mb-4 text-lg font-semibold text-secondary'>Besoin d&apos;aide</h3>
          <ul className='mb-6 space-y-2'>
            <li>
              <Link href='/contact' className='text-muted hover:text-primary hover:underline'>
                Contact
              </Link>
            </li>
            <li>
          ...
          <h3 className='mb-4 text-lg font-semibold text-secondary'>Vous êtes un élu ?</h3>
          <ul className='space-y-2'>
            <li>
              <a
...
*/}
          ...
          <div className='mt-8 flex flex-col items-center justify-center gap-4 border-t border-muted-light pt-6 text-sm md:flex-row md:justify-between'>
            ...
            <div className='flex gap-4'>
              <Link href='/license' className='text-muted hover:text-primary hover:underline'>
                Licences
              </Link>
              <span className='text-muted'>|</span>
              <Link href='/legal' className='text-muted hover:text-primary hover:underline'>
                Mentions légales
              </Link>
            </div>
          </div>
