        ...
        http.get('/api/communities_search', ({ request }) => {
          ...
          if (query.includes('paris')) {
            ...
            return HttpResponse.json([
              ...
              { nom: 'Région Auvergne-Rhône-Alpes', siren: '238400034', type: 'REG', code_postal: '69000' },
            ]);
          }
...
export const WithSuggestions: Story = {
  ...
  decorators: [
    (Story) => (
      <div className='w-96 p-4'>
        <p className='mb-4 text-sm text-gray-600'>Tapez "Paris", "Mar", ou "Lyon" pour voir les suggestions</p>
        <Story />
      </div>
    ),
  ],
...
export const SelectionTest: Story = {
  ...
  decorators: [
    (Story) => (
      <div className='w-96 p-4'>
        <p className='mb-4 text-sm text-gray-600'>Tapez et cliquez sur une suggestion pour tester la sélection</p>
        <Story />
      </div>
    ),
  ],
    ...
    (Story) => (
      <div className='w-96 p-4'>
        <div className='mb-4 text-sm text-gray-600'>
          <p><strong>Test de remise à zéro après sélection :</strong></p>
...
export const MultipleSelectionsTest: Story = {
  ...
  decorators: [
    (Story) => (
      <div className='w-96 p-4'>
        <div className='mb-4 text-sm text-gray-600'>
          <p><strong>Test de sélections multiples :</strong></p>
    ...
    (Story) => (
      <div className='w-96 p-4'>
        <div className='mb-4 p-3 bg-blue-50 rounded text-sm'>
          <p><strong>🧪 Test détaillé de la remise à zéro :</strong></p>
